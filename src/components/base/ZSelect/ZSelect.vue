<template>
  <button ref="zSelect" :class="`${prefixCls} ${isShowOptions ? prefixCls + '-open' : ''}`" @click="handleClick" @focus="handleFocus" @blur="handleBlur" @keyup.enter="handleEnter"
    @keyup.up="handleKeyupUp" @keyup.down="handleKeyupDown">
    ...
    <ul ref="zSelectOptions" :class="`${prefixCls}-options`" v-show="isShowOptions">
      <li v-for="(item, index) in options" :key="index"
        ...
        @click.stop="handleSelect(item)" @mouseover="handleMouseoverOptionItem(index)">
