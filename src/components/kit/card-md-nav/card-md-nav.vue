<template>
  <card title="目录" padding="10px 0 0">
    <div class="wrap">
      <div id="mdAnchorNavWrap" class="md-anchor-nav-wrap" v-if="articleTitles && articleTitles.nav && articleTitles.nav.length > 0">
...
import MdAnchorNav from '@/components/kit/md-anchor-nav/md-anchor-nav'
