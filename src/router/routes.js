...
const AdminLayout = () => import(/* webpackChunkName: 'AdminLayout' */ '@/components/framework/AdminLayout/AdminLayout')
const AdminHome = () => import(/* webpackChunkName: 'AdminHome' */ '@/views/admin/AdminHome/AdminHome')
const AdminWrite = () => import(/* webpackChunkName: 'AdminWrite' */ '@/views/admin/AdminWrite/AdminWrite')
const AdminArticle = () => import(/* webpackChunkName: 'AdminArticle' */ '@/views/admin/AdminArticle/AdminArticle')
const AdminCatgory = () => import(/* webpackChunkName: 'AdminCatgory' */ '@/views/admin/AdminCatgory/AdminCatgory')
const AdminTag = () => import(/* webpackChunkName: 'AdminTag' */ '@/views/admin/AdminTag/AdminTag')
const AdminResourceType = () => import(/* webpackChunkName: 'AdminResourceType' */ '@/views/admin/AdminResourceType/AdminResourceType')
const AdminResource = () => import(/* webpackChunkName: 'AdminResource' */ '@/views/admin/AdminResource/AdminResource')
const AdminUser = () => import(/* webpackChunkName: 'AdminUser' */ '@/views/admin/AdminUser/AdminUser')
const AdminComment = () => import(/* webpackChunkName: 'AdminComment' */ '@/views/admin/AdminComment/AdminComment')
